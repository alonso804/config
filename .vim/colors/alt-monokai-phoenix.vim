...
let colors_name="alt-monokai-phoenix"
...
hi PmenuSet guifg=#66D9EF guibg=#000000 gui=NONE ctermfg=81 ctermbg=233 cterm=NONE
...
" Editor
" --------------------------
hi Normal guifg=#F8F8F2 guibg=#000000 gui=NONE ctermfg=15 ctermbg=233 cterm=NONE
hi Conceal guifg=#66D9EF guibg=#000000 gui=NONE ctermfg=81 ctermbg=233 cterm=NONE
hi NonText guifg=#49483E guibg=NONE gui=NONE ctermfg=59 ctermbg=NONE cterm=NONE
hi StatusLine guifg=#66D9EF guibg=#000000 gui=NONE ctermfg=81 ctermbg=233 cterm=NONE
hi StatusLineNC guifg=#778899 guibg=#000000 gui=NONE ctermfg=103 ctermbg=233 cterm=NONE
...
hi ErrorMsg guifg=#000000 guibg=#F92672 gui=NONE ctermfg=233 ctermbg=197 cterm=NONE
...
" Tabline
" --------------------------
hi TabLine guifg=#8F908A guibg=#000000 gui=NONE ctermfg=102 ctermbg=233 cterm=NONE
hi TabLineSel guifg=#F8F8F2 guibg=#334455 gui=NONE ctermfg=15 ctermbg=59 cterm=NONE
hi TabLineFill guifg=#000000 guibg=#111111 gui=NONE ctermfg=233 ctermbg=233 cterm=NONE
...
hi Cursor guifg=#000000 guibg=#F8F8F2 gui=NONE ctermfg=233 ctermbg=15 cterm=NONE
...
hi MatchParen ctermfg=135 ctermbg=NONE cterm=underline guifg=#f92672 guibg=NONE gui=underline
"hi MatchParen ctermfg=185 ctermbg=NONE cterm=underline guifg=#f92672 guibg=NONE gui=underline
...
if has("nvim")
  ...
  " Neovim Terminal
  " --------------------------
  hi TermCursor guifg=#000000 guibg=#F8F8F2 gui=NONE ctermfg=233 ctermbg=15 cterm=NONE
  hi TermCursorNC guifg=#000000 guibg=#778899 gui=NONE ctermfg=233 ctermbg=103 cterm=NONE
...
hi Todo guifg=#F8F8F2 guibg=#000000 gui=bold ctermfg=15 ctermbg=233 cterm=bold
